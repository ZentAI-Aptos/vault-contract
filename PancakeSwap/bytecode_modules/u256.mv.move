module 0xc7efb4076dbe143cbcd98cfaaa929ecfc8f299203dfff63b95ccb6bfe19850fa::u256 {
    ...
    public fun div(arg0: U256, arg1: U256) : U256 {
        ...
        loop {
            ...
            if (v5 == 2 || v5 == 0) {
                let v6 = v4 / 64;
                put(&mut v0, v6, get(&v0, v6) | 1 << ((v4 % 64) as u8));
                let v7 = arg1;
                arg0 = sub(arg0, v7);
            };
            arg1 = shr(arg1, 1);
    ...
    public fun shl(arg0: U256, arg1: u8) : U256 {
        ...
        if (v2 > 0) {
            let v4 = v1 + 1;
            while (v4 < 4) {
                put(&mut v0, v4, get(&v0, v4) + (get(&arg0, v4 - 1 - v1) >> 64 - (v2 as u8)));
                v4 = v4 + 1;
            };
        };
        v0
    ...
    public fun shr(arg0: U256, arg1: u8) : U256 {
        ...
        if (v2 > 0) {
            let v4 = v1 + 1;
            while (v4 < 4) {
                put(&mut v0, v4 - v1 - 1, get(&v0, v4 - v1 - 1) + (get(&arg0, v4) << 64 - (v2 as u8)));
                v4 = v4 + 1;
            };
        };
        v0
